...
import static com.arturgoms.spectro.NoteMain.*;
import static com.arturgoms.spectro.NoteMain.getBackupPath;
import static com.arturgoms.spectro.NoteMain.getLocalPath;
...
public class DataUtils {
    ...
    public static final String BACKUP_FOLDER_PATH = "/Spectro/notes"; // Backup folder path
    public static final String BACKUP_FILE_NAME = "spectronotes_backup.json"; // Backup file name
