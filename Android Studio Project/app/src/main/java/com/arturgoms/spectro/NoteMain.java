...
import static com.arturgoms.spectro.DataUtils.*;

public class NoteMain extends ActionBarActivity implements AdapterView.OnItemClickListener,
...
// Initialize local file path and backup file path
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add) {
            Intent intent = new Intent(NoteMain.this, ActivityEdit.class);
